...
\begin{ejercicio}
    ...
    \begin{description}
        ...
        Aplicando esta idea a la serie de composición de $G$, obtenemos en primer lugar que $G_{r-1}$ es finito, puesto que $G_{r-1}/\{1\}$ y $\{1\}$ son finitos. Análogamente, $G_{r-2}$ es finito, puesto que $G_{r-2}/G_{r-1}$ y $G_{r-1}$ son finitos. Por inducción sobre $r$, se tiene que $G_{0}=G$ es finito.
    \end{description}
\end{ejercicio}
...
\begin{ejercicio}
    ...
    Esto equivale a probar que todo grupo de orden $p^n$ es resoluble para todo $n\in\bb{N}$.
    \begin{itemize}
        \item \ul{Caso base}: $n=1$.
        
        Sea $G$ un grupo de orden $p$. Entonces, $G$ es cíclico, luego abeliano y por tanto resoluble.

        \item \ul{Paso inductivo}: Supongamos que todo grupo de orden $p^n$ es resoluble. Demostremos que todo grupo de orden $p^{n+1}$ es resoluble.
        
        Sea $G$ un grupo de orden $p^{n+1}$. 
        Sabemos en primer lugar que $Z(G)$ es abeliano, luego resoluble.
        Por otro lado, sabemos que $|Z(G)|$ divide a $|G|$, luego $|Z(G)|=p^k$ para algún $k\in\{0,\ldots,n+1\}$.
        Además, como $G$ es un $p$-grupo, en particular su centro es no trivial, luego $k\neq 0$.
        Por tanto, tenemos que:
        \begin{equation*}
            \left|G/Z(G)\right| = \dfrac{|G|}{|Z(G)|} = \dfrac{p^{n+1}}{p^k} = p^{n+1-k}
        \end{equation*}
        Como $n+1-k<n+1$, por la hipótesis de inducción se tiene que $G/Z(G)$ es resoluble.
...
\begin{ejercicio}
    ...
    Como $n_p\mid q$, entonces $n_p\leq q\leq p$. Como $n_p\equiv 1 \mod p$, concluimos que $n_p=1$. Por tanto, $\exists! P\lhd G$ tal que $P$ es un $p$-subgrupo de Sylow de $G$. Por ser un $p-$subgrupo de Sylow de $G$, entonces $|P|=p$. Por tanto, tenemos que:
    \begin{itemize}
